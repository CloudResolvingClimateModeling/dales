  ...
  subroutine initcrosssection
   ...
   implicit none
    ...
    !if (myid==0) then  ! remnant of slab parallelization - either all do this or myidx == 0
      ...
      call ncinfo(ncname1( 12,:),'e120xz','xz crosssection of sqrt(turbulent kinetic energy)','-','t0tt')
    ...
    do cross=1,nxy
      ...
      call ncinfo(ncname2(12,:),'e120xy','xy crosssection of sqrt(turbulent kinetic energy)','-','tt0t')
    ...
    call ncinfo(ncname3(12,:),'e120yz','yz crosssection of sqrt(turbulent kinetic energy)','-','0ttt')
